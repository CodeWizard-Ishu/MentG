...
//         {/* Mobile Menu Button */}
//         <button
//           className="md:hidden fixed top-4 right-4 z-50 p-2 bg-sky-100 rounded-lg"
...
//         {/* Sidebar */}
//         <div className={`
//           w-64 bg-sky-100 shadow-md border-r overflow-y-auto
//           fixed md:relative
...
//                 />
//                 <div>
//                   <h2 className="text-2xl md:text-3xl font-bold p-2">{fullName}</h2>
//                 </div>
//               </div>
...
//             </div>
//           </div>
//           <div className="p-4 md:p-8">{renderTabContent()}</div>
//         </div>
//       </div>
